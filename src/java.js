...
function generatePoem(event){
    ...
    let context =
     "You are a humorous poem expert and love to write short playful poems. Your mission is to generate a 6 line poem in basic HTML<p></p> and separate each line with a <br/>. make sure to follow the user instructions do not include a title to the poem and sign the poem at the end and Not at the beginning in a <strong></strong> element 'SheCodes AI'";
